...
<body>
    <div class="container-fluid px-0">
      <header class="d-flex head bg-dark px-3">
          <form class="d-flex mobileSrch container-fluid mt-2" action="search.html" method="post">
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text"><i class="fa fa-arrow-left"></i></span>
              </div>
              <input class="tags form-control mr-2" type="search" placeholder="search Book-Store" />
        ...
        <div class="display bg-dark" id="searchBar">
          <form class="form-inline my-2 my-lg-0 search" action="search.html">
            <input class="tags form-control mr-sm-2" type="search" placeholder="Search Book-Store" aria-label="Search">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="d-flex flex-row btn cart" title="item added to cart"><a href="shopping-cart.php" id="itemAdd"><i class="fa fa-shopping-cart text-white" style="font-size: 28px"></i>&nbsp;<span class="badge badge-light itemCnt" style="font-size:14px; color:red; height: 21px">0</span></a></div>
